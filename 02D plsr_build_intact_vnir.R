...
levels(VIP_intact_vnir_long$variable)<-c("sol","hemi","recalc","Cmass","Nmass","LMA")

VIP_intact_vnir_plot<-ggplot(VIP_intact_vnir_long,
...
pdf("Manuscript/FigS4.pdf",height=5,width=7)
VIP_intact_vnir_plot
dev.off()
